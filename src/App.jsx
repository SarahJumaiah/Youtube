...
const App = () => {
  ...
  return (
    <div className="h-screen md:h-screen bg-white flex flex-col justify-center items-center">
      <div className="border border-gray-300 bg-white shadow-sm md:shadow-lg rounded p-10">
        <div className="flex flex-col items-center space-y-3">
          ...
          <span className="text-2xl font-semi-bold leading-normal">Log in</span>
        ...
        <form className="my-8" onSubmit={handleLogin}>
          <div className="relative mb-2">
            <input
              id="username"
              className="w-full rounded px-3 border border-gray-300  bg-white focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none input active:outline-none"
              type="text"
              value={username}
            ...
            <label
              htmlFor="username"
              className="label absolute ml-3 text-gray-600 text-base"
            >
              Username
            </label>
          </div>
